...
\item \texttt{Amdmt}: Cateogircal variable representing one of three soil additives; none, biochar, freshbiomas.
\item \texttt{ID}:
\end{itemize}


, is an indicator of whether plants are in the soil,  is a categorical variable representing 
...
```{r}
mod_cov <- bbdml(formula = OTU.4 ~ DayAmdmt,
