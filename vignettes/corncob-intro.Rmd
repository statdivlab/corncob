...
The code to generate this data from `soil_phylo` is commented out.
...
`corncob` is stable, but new. If you notice any issues, please [log them on Github](https://github.com/statdivlab/corncob/issues) to help us help you!
